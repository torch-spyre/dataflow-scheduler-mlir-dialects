...
// CHECK-NEXT:     ktdf.data_transfer from %[[ALLOC_0]]{{\[}}%[[CONSTANT_0]]] size [64] to %[[FIFO_0]] size [64] : memref<64xf16, "L1">, !ktdf.fifo.slot<"L1LU" -> "SFU", 64xf16>
// CHECK-NEXT:     return
// CHECK-NEXT:   }
...
// CHECK-NEXT:     ktdf.data_transfer from %[[FIFO_0]] to %[[ALLOC_0]]{{\[}}%[[CONSTANT_0]]] size [64] : !ktdf.fifo.slot<"L1LU" -> "SFU", 64xf16>, memref<64xf16, "SFU_REG">
// CHECK-NEXT:     return
// CHECK-NEXT:   }
...
// CHECK-NEXT:         ktdf.data_transfer from %[[ALLOC_5]]{{\[}}%[[CONSTANT_0]]] size [64] to %[[FIFO_0]]#0 size [64] : memref<64xf16, "L1">, !ktdf.fifo.slot<"L1LU" -> "SFU", 64xf16>
// CHECK-NEXT:         ktdf.data_transfer from %[[ALLOC_6]]{{\[}}%[[CONSTANT_0]]] size [64] to %[[FIFO_0]]#1 size [64] : memref<64xf16, "L1">, !ktdf.fifo.slot<"L1LU" -> "SFU", 64xf16>
// CHECK-NEXT:         ktdf.data_transfer from %[[FIFO_0]]#0 to %[[ALLOC_8]]{{\[}}%[[CONSTANT_0]]] size [64] : !ktdf.fifo.slot<"L1LU" -> "SFU", 64xf16>, memref<64xf16, "SFU_REG">
// CHECK-NEXT:         ktdf.data_transfer from %[[FIFO_0]]#1 to %[[ALLOC_9]]{{\[}}%[[CONSTANT_0]]] size [64] : !ktdf.fifo.slot<"L1LU" -> "SFU", 64xf16>, memref<64xf16, "SFU_REG">
// CHECK-NEXT:         ktdf.data_transfer from %[[ALLOC_10]]{{\[}}%[[CONSTANT_0]]] size [64] to %[[FIFO_1]] size [64] : memref<64xf16, "SFU_REG">, !ktdf.fifo.slot<"SFU" -> "L1SU", 64xf16>
// CHECK-NEXT:         ktdf.data_transfer from %[[FIFO_1]] size [64] to %[[ALLOC_7]]{{\[}}%[[CONSTANT_0]]] size [64] : !ktdf.fifo.slot<"SFU" -> "L1SU", 64xf16>, memref<64xf16, "L1">
// CHECK-NEXT:       }
// CHECK-NEXT:       ktdf.stage depends_in(none) depends_out(none) {
...
func.func @test_data_transfer_memref_to_fifo() {
  ...
  ktdf.data_transfer from %l1_A[%c0] size [64] to %fifo_slot size [64] : memref<64xf16, "L1">, !ktdf.fifo.slot<"L1LU" -> "SFU", 64xf16>
  return
}
...
func.func @test_data_transfer_fifo_to_memref() {
  ...
  ktdf.data_transfer from %fifo_slot to %sfu_A[%c0] size [64] : !ktdf.fifo.slot<"L1LU" -> "SFU", 64xf16>, memref<64xf16, "SFU_REG">
  return
}
...
func.func @test_data_transfer_in_pipeline() {
  ...
  ktdf.pipeline {
    ...
    ktdf.stage depends_in(none) depends_out(none) {
      ...
      %fifo_slot_a, %fifo_slot_b = ktdf.fifo.allocate() -> !ktdf.fifo.slot<"L1LU" -> "SFU", 64xf16>, !ktdf.fifo.slot<"L1LU" -> "SFU", 64xf16>
      ...
      ktdf.data_transfer from %l1_A[%c0] size [64] to %fifo_slot_a size [64] : memref<64xf16, "L1">, !ktdf.fifo.slot<"L1LU" -> "SFU", 64xf16>
      ktdf.data_transfer from %l1_B[%c0] size [64] to %fifo_slot_b size [64] : memref<64xf16, "L1">, !ktdf.fifo.slot<"L1LU" -> "SFU", 64xf16>
      ktdf.data_transfer from %fifo_slot_a to %sfu_A[%c0] size [64] : !ktdf.fifo.slot<"L1LU" -> "SFU", 64xf16>, memref<64xf16, "SFU_REG">
      ktdf.data_transfer from %fifo_slot_b to %sfu_B[%c0] size [64] : !ktdf.fifo.slot<"L1LU" -> "SFU", 64xf16>, memref<64xf16, "SFU_REG">
      ktdf.data_transfer from %sfu_out[%c0] size [64] to %fifo_slot_c size [64] : memref<64xf16, "SFU_REG">, !ktdf.fifo.slot<"SFU" -> "L1SU", 64xf16>
      ktdf.data_transfer from %fifo_slot_c size [64] to %l1_C[%c0] size [64] : !ktdf.fifo.slot<"SFU" -> "L1SU", 64xf16>, memref<64xf16, "L1">
    }
