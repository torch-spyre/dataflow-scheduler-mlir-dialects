...
// CHECK-NEXT:     ktdf.write_to_fifo %[[CONSTANT_0]], %[[FIFO_0]] : tensor<64xf16>, <"l1lu-to-sfu", 64xf16>
...
// CHECK-NEXT:     ktdf.write_to_fifo %[[CONSTANT_1]], %[[FIFO_1]] : tensor<8xf32>, <"sfu-to-l1su", 8xf32>
// CHECK-NEXT:     return
// CHECK-NEXT:   }
...
module {
  func.func @write_to_fifo_static() {
    ...
    ktdf.write_to_fifo %data0, %slot0 : tensor<64xf16>, !ktdf.fifo.slot<"l1lu-to-sfu", 64xf16>
    ...
    ktdf.write_to_fifo %data1, %slot1 : tensor<8xf32>, !ktdf.fifo.slot<"sfu-to-l1su", 8xf32>
