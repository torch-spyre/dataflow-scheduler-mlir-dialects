...
// agen.yield is the implicit terminator of agen.composite_load_and_store's
// body region.  It carries no operands in this op, so the printer elides it
// as a bare "agen.yield" line.  We exercise it inside composite_load_and_store.
...
// CHECK-LABEL:   func.func @yield_inside_composite(
...
module {
  func.func @yield_inside_composite(%arg0: memref<64xf16>, %arg1: memref<64xf16>) {
